...
int Plaintext[100]; // Відкритий текст
long long Ciphertext[100]; // Зашифрований текст
int n, e = 0, d;
...
int BianaryTransform(int num, int bin_num[])
{
	...
	// Перетворюється на двійковий, зворотний тимчасово зберігається в масиві temp []
	while (num != 0)
	{
		mod = num % 2;
		bin_num[i] = mod;
	...
	// Повертає кількість цифр у двійкових числах
	return i;
}

// Повторне зведення в квадрат у степінь
...
// Генерація простих чисел у межах 1000
...
void RSA_Initialize()
{
	// Виймаємо прості числа в межах 1000 і зберігаємо їх у масиві prime[]
	int prime[5000];
	int count_Prime = ProducePrimeNumber(prime);

	// Випадково візьмемо два прості числа p, q
	...
	// Використовуємо розширений алгоритм Евкліда, щоб знайти e, d
